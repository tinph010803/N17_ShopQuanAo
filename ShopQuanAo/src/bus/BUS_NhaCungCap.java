...
public class BUS_NhaCungCap {
	public boolean kiemtra_themNCC(String ma, String ten, String sdt,
	...
	public boolean kiemtra_update(String ten, String sdt, String email,
			String diaChi) {
	...
	public static String createMa() {
		...
		ResultSet rs = ConnectionManager
				.getdata("use SFSHOP SELECT top 1  * FROM NhaCungCap ORDER BY maNhaCungCap desc");
		String ma = "";
		try {
			while (rs.next())
