...
//	public static void timKiem(JTable tbl, String tukhoa, String loai, String gia, String mau, String chatLieu) {
//		DefaultTableModel tblModel = (DefaultTableModel) tbl.getModel();
//		tblModel.setRowCount(0);
//		Object obj[] = new Object[2];
//		ResultSet rs = dao.DAO_SanPham.timKiem(tukhoa, loai, gia, mau, chatLieu);
//		try {
//			while (rs.next()) {
//				obj[0] = rs.getString("maSanPham");
//				obj[1] = rs.getString("tenSanPham");
//				obj[2] = rs.getString("loai");
//				obj[3] = rs.getString("giaNhap");
//				tblModel.addRow(obj);
//			}
//		} catch (SQLException ex) {
//			System.out.println("Lỗi đổ table");
