...
public class BUS_KhuyenMai {
	...
	public static void timKiem(JTable tbl, String tukhoa, String phanTram,
		...
		ResultSet rs = dao.DAO_KhuyenMai.timKiem(tukhoa, phanTram, sqlNgayBD,
				sqlNgayKT);
		try {
	...
	public static void dodulieu_SanPham(JTable tbl, List<SanPham> ds) {
		...
		for (SanPham sp : ds) {
			...
			tblModel.addRow(new String[] { String.valueOf(i),
					sp.getMaSanPham().trim(), sp.getTenSanPham().trim(),
					sp.getLoai().getValue(),
